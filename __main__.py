...
Create a self-evolving benchmark generator.
...
- Code should be uploaded to GitHub for review
...
To Do:
1. 
.. Streamlit Website (aka self-chat?) Було б прикольно оформити це у вигляді переписки в месенджері
"""
